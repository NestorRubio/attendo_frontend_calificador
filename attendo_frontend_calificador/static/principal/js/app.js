    ...
    function layoutSetting() {
        ...
        $('#mode-setting-btn').on('click', function (e) {
            if (body.hasAttribute("data-layout-mode") && body.getAttribute("data-layout-mode") == "dark") {
                ...
                if (localStorage.getItem("data-topbar") == 'dark' && body.getAttribute("data-layout") !== "horizontal") {
                    document.body.setAttribute('data-sidebar', 'brand'); //Originalmente es light
                    document.body.setAttribute('data-topbar', 'dark');
                }
                document.body.setAttribute('data-layout-mode', 'light');
                if (localStorage.getItem("data-topbar") !== 'dark') {
                    document.body.setAttribute('data-topbar', 'dark'); //Originalmente es light
                    updateRadio('topbar-color-light');
                }
        ...
        $("input[name='layout-mode']").on('change', function () {
            if ($(this).val() == "light") {
                document.body.setAttribute('data-layout-mode', 'light');
                document.body.setAttribute('data-topbar', 'dark');
                document.body.setAttribute('data-sidebar', 'brand'); // Ojo aquí le cambié de light a brand
                (body.hasAttribute("data-layout") && body.getAttribute("data-layout") == "horizontal") ? '' : document.body.setAttribute('data-sidebar', 'brand'); //Originalmente era light lo que ahora es brand
        ...
        $("input[name='layout-direction']").on('change', function () {
            if ($(this).val() == "ltr") {
                ...
                document.getElementById('bootstrap-style').setAttribute('href', '/static/principal/css/bootstrap.min.css');
                document.getElementById('app-style').setAttribute('href', '/static/principal/css/app.min.css');
            } else {
                document.getElementById('bootstrap-style').setAttribute('href', '/static/principal/css/bootstrap-rtl.min.css');
                document.getElementById('app-style').setAttribute('href', '/static/principal/css/app-rtl.min.css');
